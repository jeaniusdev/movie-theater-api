  ...
  <div class="relative isolate overflow-hidden">
    ...
    <header class="pb-4 pt-6 sm:pb-6">
      <div class="mx-auto flex max-w-7xl flex-wrap items-center gap-6 px-4 sm:flex-nowrap sm:px-6 lg:px-8">
        ...
        <form action="{{ route('sales.topTheater') }}" method="POST" class="flex items-center gap-2">
            @csrf
            <input type="date" name="calendar_date" class="border border-gray-300 rounded-md p-2" required>
        ...
        <input type="date" class="ml-auto rounded-md border border-gray-300 px-3 py-2 text-sm focus:outline-none focus:border-indigo-500" />
      </div>
    </header>
    ...
    <div class="border-b border-b-gray-900/10 lg:border-t lg:border-t-gray-900/5">
      <dl class="mx-auto grid max-w-7xl grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 lg:px-2 xl:px-0">
        <div class="flex flex-wrap items-baseline justify-between gap-x-4 gap-y-2 border-t border-gray-900/5 px-4 py-10 sm:px-6 lg:border-t-0 xl:px-8">
          <dt class="text-sm font-medium leading-6 text-gray-500">AMC</dt>
        ...
        <div class="flex flex-wrap items-baseline justify-between gap-x-4 gap-y-2 border-t border-gray-900/5 px-4 py-10 sm:border-l sm:px-6 lg:border-t-0 xl:px-8">
          <dt class="text-sm font-medium leading-6 text-gray-500">Regal</dt>
  ...
  <div class="space-y-16 py-16 xl:space-y-20">
    <div>
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <h2 class="mx-auto max-w-2xl text-base font-semibold leading-6 text-gray-900 lg:mx-0 lg:max-w-none">Recent sales</h2>
      </div>
